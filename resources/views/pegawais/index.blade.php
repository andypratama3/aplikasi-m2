                                ...
                                <div class="row">
                                    <div class="col-10 media-body mb-2">
                                        <div class="content-header-left breadcrumb-new">
                                            <span class="content-header-title mb-0 d-inline-block font-medium-4"><b>Pegawai</b></span>
                                    ...
                                    <div class="col-2 text-right">
                                        @can('pegawais.create')
                                        <a href="{{ route('pegawais.create') }}" class="btn btn-sm btn-green">Tambah Pegawai
                                        </a>
                                        @endcan
                                    </div>
                                </div>
