...
class {{ $config->modelNames->name }}Controller extends AppBaseController
{
    ...
    {
        $this->middleware('permission:{{$config->modelNames->camelPlural}}.index', ['only' => ['index','show']]);
        $this->middleware('permission:{{$config->modelNames->camelPlural}}.create', ['only' => ['create','store']]);
        $this->middleware('permission:{{$config->modelNames->camelPlural}}.edit', ['only' => ['edit','update']]);
        $this->middleware('permission:{{$config->modelNames->camelPlural}}.destroy', ['only' => ['destroy']]);
