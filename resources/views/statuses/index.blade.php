                                ...
                                <div class="row">
                                    <div class="col-10 media-body mb-2">
                                        <div class="content-header-left breadcrumb-new">
                                            <span class="content-header-title mb-0 d-inline-block font-medium-4"><b>Statuses</b></span>
                                    ...
                                    <div class="col-2 text-right">
                                        @can('statuses.index')
                                        <a href="{{ route('statuses.create') }}" class="btn btn-sm btn-green">Tambah Data
                                        </a>
                                        @endcan
                                    </div>
                                </div>
