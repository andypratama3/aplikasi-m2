                        ...
                        <div class="card-content">
                            <div class="media align-items-stretch">
                                ...
                                <div class="media-body p-1">
                                    <span class="indigo font-medium-5">Perubahan Post Category</span><br>
                                    <span style="margin-top: -5px">Melakukan Perubahan Post Category </span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body row">
                                    ...
                                    <div class="form-actions col-md-12 center">
                                        <a href="{{ route('postCategories.index') }}" class="btn btn-default">Batal</a>
