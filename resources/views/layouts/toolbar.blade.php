            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{('/')}}">
                        <img alt="robust admin logo" src="{{asset('image/logo_black.png')}}" height="45">
                    </a>
                </li>
                        ...
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online">
                                @if(empty(Auth::user()->getFirstMedia('foto')))
                                    <img src="{{ asset('master/app-assets/images/gallery/user_profil.png')}}" alt="avatar"><i></i>
                                @else
                                    <img src="{{ Auth::user()->getFirstMedia('foto')->getUrl()  }}" alt="avatar"><i></i>
                                @endif
                            </span>

                            <span class="user-name text-uppercase font-small-3 text-bold-600">{!! Auth::user()->name !!}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="/profil"><i class="ft-user"></i> Edit Profile</a>
