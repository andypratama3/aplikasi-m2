            ...
            <div class="row">
                        ...
                        <div class="card-content">
                            <div class="media align-items-stretch">
                                ...
                                <div class="media-body p-1">
                                    <span class="green font-medium-5 text-bold-600">Input Kategori Page</span><br>
                                    <span style="margin-top: -5px">Membuat Kategori Page Baru</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card overflow-hidden rounded-2">
                        <div class="card-content">
                            <div class="card-body">
                                {!! Form::open(['route' => 'pageCategories.store'], ['class' => 'form']) !!}
                                <div class="row">
