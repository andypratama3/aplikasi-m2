                                ...
                                <div class="row">
                                    <div class="col-10 media-body mb-2">
                                        <div class="content-header-left breadcrumb-new">
                                            <span class="content-header-title mb-0 d-inline-block font-medium-4"><b>Kegiatan</b></span>
                                    ...
                                    <div class="col-2 text-right">
                                        @can('kegiatans.index')
                                        <a href="{{ route('kegiatans.create') }}" class="btn btn-sm btn-green">Tambah Data
                                        </a>
                                        @endcan
                                    </div>
                                </div>
