                        ...
                        <div class="card-content">
                            <div class="media align-items-stretch">
                                ...
                                <div class="media-body p-1">
                                    <span class="green font-medium-5">Input Jabatan</span><br>
                                    <span style="margin-top: -5px">Membuat Jabatan Baru</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body row">
                                    ...
                                    <div class="form-actions center col-md-12">
                                        <a href="{{ route('jabatans.index') }}" class="btn btn-default">Kembali</a>
